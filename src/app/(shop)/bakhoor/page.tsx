...
const LOCKED = { categorySlug: 'bakhoor' as const };
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
            {[
              {
                step: '01',
                title: 'Heat the Burner',
                desc: 'Light a charcoal disc in your mabkhara and let it become grey-white before placing bakhoor on it.',
              },
              {
                step: '02',
                title: 'Place the Bakhoor',
                desc: 'Add a small piece of bakhoor onto the hot charcoal. The smoke will begin rising immediately.',
              },
              {
                step: '03',
                title: 'Let it Breathe',
                desc: 'Move the burner around your home or hold clothing over the smoke for 30–60 seconds to scent fabric.',
              },
            ].map((s) => (
              <div key={s.step}>
                <p
                  className="text-3xl font-light mb-2"
                  style={{ color: 'rgba(201,168,76,0.3)', fontFamily: 'var(--font-heading)' }}
                >
                  {s.step}
                </p>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 mt-8 text-xs font-bold uppercase tracking-wider"
            style={{ color: '#C9A84C' }}
          >
            View all bakhoor <ArrowRight size={13} />
          </Link>
        </div>
      </div>
    </div>
